...
@section('content')
<div class="container card-body justify-content-center bg-dark sm text-light rounded">
    ...
    <form action="{{ route('frontend-show') }}" method="get">
        ...
        <div class="btn-group">
            ...
            <a href="{{ route('frontend-show') }}" class="btn btn-outline-info">Reset</a>
        </div>
...
{{-- <li id="{{ $fcity->id }}">{{ $fcity->title }} {{ $fcity->restaurants()->count() }}
                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="btn-group">
                                <form action="{{ route('frontend-restaurant-menu', $frestaurant) }}" method="get">
                                    <button class="btn btn-sm btn-outline-secondary">View menu <button class="btn btn-sm btn-outline-secondary">{{ $frestaurant->dishes()->count() }}</button></button>
